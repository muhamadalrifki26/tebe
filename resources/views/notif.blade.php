		...
		<div class="col-md-8">
			<table class="manage-table responsive-table">
				...
				<tr>
					...
					<th class="expire-date"><i class="fa fa-calendar"></i> Waktu</th>
					<th></th>
				</tr>

				<!-- Item #1 -->
				@foreach($data as $key => $value)
				@foreach($value->pemesanan_tempat as $key => $value2)
				<tr>
					<td class="title-container">
						...
						<div class="title">
							...
							<span class="table-property-price">{{ $value->tarif_peserta }} Perpeserta</span>
						</div>
					</td>
					...
					<td class="action">
						...
						<a href="/setujutempat/{{$value2->id}}"><i class="fa fa-check-circle"></i> Setuju</a>
						<a href="/tolaktempat/{{$value2->id}}" class="delete"><i class="fa fa-remove"></i> Tolak</a>
						@else
							{{ $value2->konfirmasi }}
						@endif
